...
<p align="center">
  <b >v1.13.2</b> — мощный Telegram-бот для мониторинга и управления вашей <b>сетью серверов</b>. Теперь на базе <b>SQLite</b> и полностью <b>асинхронного ядра</b> (AsyncIO). Поддержка <b>множества нод</b>, веб-интерфейс и полная интеграция с <b>Docker</b>.
</p>
...
```bash
bash <(wget -qO- https://raw.githubusercontent.com/botcott/tgbotvpscp/main/deploy.sh)
````
