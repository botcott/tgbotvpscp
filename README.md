...
<p align="center">
  <b >v1.12.3</b> — мощный Telegram-бот для мониторинга и управления вашей <b>сетью серверов</b>. Теперь на базе <b>SQLite</b> и полностью <b>асинхронного ядра</b> (AsyncIO). Поддержка <b>множества нод</b>, веб-интерфейс и полная интеграция с <b>Docker</b>.
</p>
...
<p align="center">
  ...
  <a href="CHANGELOG.md"><img src="https://img.shields.io/badge/build-50-purple?style=flat-square" alt="Build 50"/></a>
...
<details>
<summary><h2>🧩 Добавление модуля</h2></summary>

1.  **Файл:** Создайте `modules/my_module.py`.
2.  **Код:** Используйте `BUTTON_KEY` и `register_handlers(dp)`.
3.  **i18n:** Добавьте строки в `core/i18n.py`.
