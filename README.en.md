...
<p align="center">
  <b >v1.12.3</b> — a powerful Telegram bot for monitoring and managing your <b>server network</b>. Now powered by <b>SQLite</b> and a fully <b>asynchronous core</b> (AsyncIO). Features <b>multi-node support</b>, a web interface, and full <b>Docker</b> integration.
</p>

<p align="center">
  <a href="https://github.com/jatixs/tgbotvpscp/releases/latest"><img src="https://img.shields.io/badge/version-v1.12.4-blue?style=flat-square" alt="Version 1.12.4"/></a>
  <a href="CHANGELOG.en.md"><img src="https://img.shields.io/badge/build-50-purple?style=flat-square" alt="Build 50"/></a>
