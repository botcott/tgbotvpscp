...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/date-Декабрь%202025-green?style=flat-square" alt="Date December 2025"/>
...
* **Устранены критические ошибки кода (Crash Fixes):** Исправлены ошибки отступов (`IndentationError`) в модулях `fail2ban.py`, `sshlog.py`, `notifications.py`, `selftest.py` и `core/utils.py`. Эти ошибки могли приводить к полному падению процесса бота при возникновении исключений.
* **Исправлена логика Fail2Ban:** Исправлена опечатка в имени команды (`fall2ban` -> `fail2ban`), из-за которой модуль не работал.

### 🚀 Оптимизация производительности (Low-End Server Optimization)
