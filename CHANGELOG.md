...
* **Совместимость с Docker (ProcFS):**
    * Исправлена ошибка `500 Internal Server Error` и `OCI runtime create failed`, возникавшая на новых версиях Docker и ядер Linux из-за запрета монтирования поверх системной директории `/proc` (masked paths).
